...
const SITE = {
  ...
  sections: [
    ...
    // ── 02 — Research ──────────────────────────────────────────
    {
      ...
      body: [
        "Research for Tiles combined domain expertise, review of adjacent tools, and direct in-studio feedback rather than formal academic study. Desk research drew on two existing apps as inspiration, alongside almost a decade of personal experience in clay studios and teaching. The most valuable research came from watching real potters use the prototype directly. Two rounds of testing were conducted: the first with the Squeaky Wheel Pottery studio owner, a member, and an instructor on an early build, and the second with community studio professional Molly Rivera from Red Wing Arts after the community board was added. Round one shaped the app's direction, surfacing the need for the community board and ideas around education and materials tracking. Round two tested and refined that more complete version.",
      ],
      ...
      steps: [
        ...
        { label: "Data Collection",     detail: "Feedback was gathered informally, through in-person conversation and observation rather than surveys or structured interviews. A small group of people, including a studio owner, a member, an instructor, and later a community studio professional, interacted with the prototype across two rounds. This traded breadth for depth. Fewer participants, but feedback rooted in real studio use." },
    ...
    // ── 06 — Summary ───────────────────────────────────────────
    {
      ...
      body: [
        ...
        "Looking back, the clearest thing to do differently would be more user research. More interviews, more observation, more time spent watching people actually use the tool.",
